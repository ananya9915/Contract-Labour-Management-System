...
var lcno=workfrm.lcno.value;
   ...
   if(workfrm.lcno.value=="" || workfrm.lcno.value==" " )
	{
	alert("Please Enter WorkOrder License Number");
	workfrm.lcno.value="";
	workfrm.lcno.focus();
		return false;
	}
	...
	var str1="e";
	 ...
	 if(s.charAt(0)==str)
        ...
        {
		  workfrm.action="WorkOrderUpdateDetails.jsp?lcno=" + lcno;
...
cellPadding=0 border=0 bordercolorlight="#668CA2" bordercolordark="#668CA2" bgcolor="#FFFFFF" width="100%" height="50" align="center">
        <tr bgcolor="#227CA8"> 
          <td colspan="2" align="center" height="19"> 
            <div align="left"><font color="#FFFFFF" face="Verdana" size="2"><b>Update 
              Work Order Details</b></font></div>
          </td>
        </tr>
        <tr> 
        ...
        <tr bgcolor="#227CA8" align="left"> 
		  ...
		  <input type="submit" align="left" value="  Back  " 
		   onClick="Back()" name="submit" style="font-weight: bold;cursor:hand; border-style: outset; border-width:0; color:#229CA8"  > 
