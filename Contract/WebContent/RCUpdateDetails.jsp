...
function CheckInput()
{
 ...
 var sel=1;
   ...
   if(Licfrm.distname.selectedIndex==0)
	...
	{
	alert("Please Enter Work Order Issue Date");
	Licfrm.wdate.focus();
	return false;
...
function validateRcno(rcno)
{
    ...
    var oldrcno=Licfrm.orgrcno.value;
    
	
	if(!(Licfrm.rcno.value==oldrcno))
	{
...
<form name="Licfrm" method="POST" action="UpdateCertificate">
...
<jsp:include page="MemberHeader.html" />
  ...
  <%
   ...
   rs = CBean.executeQuery("select to_char(sysdate,'dd-Mon-yyyy') from dual");
         ...
         rs.next();
	 wdate=rs.getString(1);
	 rs.close();
   
   
   
   
    rs=CBean.executeQuery("select distcode,rcno,company,noofworkers,nwork,fpaid,vchno,to_char(pdate,'dd-Mon-yyyy'),bank,woisdt,phno from company_master where rcno='" + rcno + "' ");
   rs.next();
   ...
   String nawork=rs.getString(5);
   String fpaid=rs.getString(6);
   String vchno=rs.getString(7);
   String pdate=rs.getString(8);
   String bank=rs.getString(9);
   String wisdate=rs.getString(10);
...
cellPadding=0 border=0 bordercolorlight="#668CA2" bordercolordark="#668CA2" bgcolor="#FFFFFF" width="100%" height="50" align="center">
        <tr bgcolor="#227CA8"> 
          <td colspan="2" align="center" height="19"> 
            <div align="left"><font color="#FFFFFF" face="Verdana" size="2"><b>
              Registration Certificate Modification</b></font></div>
          </td>
        </tr>
        <tr> 
          ...
          <td height="20" width="1221" bgcolor="#FFFFFF"><b> <font face="Verdana, Arial, Helvetica, sans-serif"> 
            <select name="distname" onchange="SetDistCode()">
              ...
              <option selected>Visakhapatnam</option>
			   <input type=hidden name="distcode" value="1"  size="20" style="font-family: Verdana; font-weight: bold; border-style: outset; border-width: 1; color:#227CA8" >
			  <%
			  }else if(dcode.equals("2"))
			  {
			  %>
			  
              <option>Srikakulam</option>
              <option selected>Vizianagaram</option>
              <option>Visakhapatnam</option>
			  <input type=hidden name="distcode" value="2"  size="20" style="font-family: Verdana; font-weight: bold; border-style: outset; border-width: 1; color:#227CA8" >
            <%
			}			else if(dcode.equals("3"))
			  {
			  %>
			  
              <option selected>Srikakulam</option>
              <option >Vizianagaram</option>
              <option >Visakhapatnam</option>
			<input type=hidden name="distcode" value="3"  size="20" style="font-family: Verdana; font-weight: bold; border-style: outset; border-width: 1; color:#227CA8" >
			<%
			}
			%>
        ...
        <tr> 
          ...
          <td height="20" width="1221" bgcolor="#FFFFFF"> <font face="Verdana, Arial, Helvetica, sans-serif">
            ...
            <input type="text" name="rcno"  value="<%=rcno1%>"
			 size="35" style="font-family: Verdana; font-weight: bold; border-style: outset; border-width: 1; color:#227CA8"  onblur="validateRcno(this.value);">
            
			<input type="hidden" name="orgrcno"  value="<%=rcno1%>"
			 size="35" style="font-family: Verdana; font-weight: bold; border-style: outset; border-width: 1; color:#227CA8"  >
			</font></td>
        </tr>
        <tr> 
          ...
          <td height="20" width="1221" bgcolor="#FFFFFF"><b> <font face="Verdana, Arial, Helvetica, sans-serif">
            <textarea name="padname"  maxlength=200 cols=30 rows=4 style="font-family: Verdana; font-weight: bold; border-style: outset; border-width: 1; color:#227CA8" ><%=cmp%> </textarea>
            </font></b></td>
        </tr>
		
		  <tr> 
          <td height="20" width="249"><b> <font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#227CA8">Phone 
            No/Mobile No</font></b></td>
          <td height="20" width="1221" bgcolor="#FFFFFF"><b> <font face="Verdana, Arial, Helvetica, sans-serif">
           
		      <input type="text" name="phno"  onkeyup="NoCheck(this)"  maxlength=12 value="<%=phno%>" size="35" style="font-family: Verdana; font-weight: bold; border-style: outset; border-width: 1; color:#227CA8"  >
            </font></b></td>
        </tr>
          ...
          <td height="20" width="249"><b> <font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#227CA8">Nature 
            Of Work</font></b></td>
          <td height="20" width="1221" bgcolor="#FFFFFF"><b> <font face="Verdana, Arial, Helvetica, sans-serif">
            <textarea name="nwork"  onkeyup="AlphaNumeric(nwork)" maxlength=200 cols=50 rows=4 style="font-family: Verdana; font-weight: bold; border-style: outset; border-width: 1; color:#227CA8" ><%=nawork%> </textarea>
            </font></b></td>
        </tr>
          ...
          <td height="20" width="1221" bgcolor="#FFFFFF"> <font face="Verdana, Arial, Helvetica, sans-serif">
            ...
            <input type="text" name="noworkers"   onkeyup="AlphaNumeric(noworkers)"  value="<%=noworks%>" size="60" maxlength=250 style="font-family: Verdana; font-weight: bold; border-style: outset; border-width: 1; color:#227CA8"  >
            </font></td>
        </tr>
		
		
			  <tr> 
          <td height="20" width="249"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#227CA8">WorkOrder 
            Issue Date</font></b></td>
          <td height="20" width="1221" bgcolor="#FFFFFF"><b> <font face="Verdana, Arial, Helvetica, sans-serif"> 
          	<input type="text" name="wdate"  readonly value="<%=wisdate%>"  size="20" style="font-family: Verdana; font-weight: bold; border-style: outset; border-width: 1; color:#227CA8" >
...
<a href="javascript:void(0)" onclick="if(self.gfPop)gfPop.fPopCalendar(document.Licfrm.wdate);
        ...
        <tr> 
          <td height="20" width="249"><b><font face="Verdana, Arial, Helvetica, sans-serif" size="2" color="#227CA8">Fee 
            Paid  Rs</font></b></td>
          <td height="20" width="1221" bgcolor="#FFFFFF"><b> <font face="Verdana, Arial, Helvetica, sans-serif"> 
           <input type="text" name="fpaid"  onkeyup="AlphaNumeric(fpaid)"   value="<%=fpaid%>"  size="20" style="font-family: Verdana; font-weight: bold; border-style: outset; border-width: 1; color:#227CA8" >
          ...
          <td height="20" width="1221" bgcolor="#FFFFFF"><b> <font face="Verdana, Arial, Helvetica, sans-serif"> 
           <input type="text" name="vchno" onkeyup="AlphaNumeric(vchno)"   value="<%=vchno%>"  size="50" style="font-family: Verdana; font-weight: bold; border-style: outset; border-width: 1; color:#227CA8" >
          ...
          <td height="20" width="1221" bgcolor="#FFFFFF"><b> <font face="Verdana, Arial, Helvetica, sans-serif"> 
           <input type="text" name="pdate"  value="<%=pdate%>" readonly onkeyup="onlyno(noworkers)" size="20" style="font-family: Verdana; font-weight: bold; border-style: outset; border-width: 1; color:#227CA8" >
          ...
          <td height="20" width="1221" bgcolor="#FFFFFF"><b> <font face="Verdana, Arial, Helvetica, sans-serif"> 
           <input type="text" name="bname"  onkeyup="CharCheck(this)" value="<%=bank%>"  size="50" style="font-family: Verdana; font-weight: bold; border-style: outset; border-width: 1; color:#227CA8" >
        ...
        <tr bgcolor="#227CA8"> 
          <td colspan="2" align="center" height="25"><font color="#CCFFCC"><b> <input type="submit"  value="  Update  " onClick="return CheckInput()" name="submit" style="font-weight: bold; cursor:hand;border-style: outset; border-width:0; color:#229CA8"  > 
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp <input type="submit" value="   Close  "   onclick="Back()" style="font-weight: bold;cursor:hand; border-style: outset; border-width:0; color:#229CA8" > 
            </b></font></td>
        </tr>
      </table>
      </center>
