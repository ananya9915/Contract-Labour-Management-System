<script>
function GetPEReport()
{

workfrm.action="PEDetails.jsp";
...
workfrm.action="PEExcelDetails.jsp";
...
cellPadding=0 border=0 bordercolorlight="#668CA2" bordercolordark="#668CA2" bgcolor="#FFFFFF" width="100%" height="50" align="center">
        <tr bgcolor="#227CA8"> 
          <td colspan="2" align="center" height="19"> 
            <div align="left"><font color="#FFFFFF" face="Verdana" size="2"><b>Principal 
              Employee Details</b></font></div>
          </td>
        </tr>
        <tr> 
		...
		<tr bgcolor="#227CA8" align="left"> 
          <td colspan="2" height="25"><font color="#CCFFCC"><b> 
		   ...
		   onClick="return GetPEReport()" name="submit" style="font-weight: bold;cursor:hand; border-style: outset; border-width:0; color:#229CA8"  > 
